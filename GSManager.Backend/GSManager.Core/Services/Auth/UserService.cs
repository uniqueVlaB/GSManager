...
namespace GSManager.Core.Services.Auth;
    ...
    IMailer mailer) : IUserService
{
    ...
    public async Task<PagedResultDto<UserResponseDto>> GetUsersAsync(PagedRequestDto pagedRequest, CancellationToken cancellationToken)
    {
